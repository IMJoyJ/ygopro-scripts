...
-- 过滤满足条件的怪兽，包括属于外星卡组、可以特殊召唤、并且其等级总和等于目标等级的怪兽
...
-- 过滤满足条件的怪兽，包括属于外星卡组、等级等于目标等级、并且可以特殊召唤
...
-- 处理效果的发动，包括检查场上是否有空位、提示选择要特殊召唤的怪兽、执行特殊召唤或造成伤害
function c24082387.activate(e,tp,eg,ep,ev,re,r,rp)
	-- 检查场上是否还有空位，如果没有则造成2000点伤害
