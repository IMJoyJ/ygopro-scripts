...
-- 定义用于检索的怪兽过滤条件，包括龙族、光属性、7星且能回到手牌
...
-- 设置效果的目标选择逻辑，确保选择的是自己场上的符合条件的怪兽
...
-- 定义用于特殊召唤的怪兽过滤条件，包括龙族、光属性、7星且能特殊召唤
...
-- 设置特殊召唤效果的目标选择逻辑，检查手牌中是否存在符合条件的怪兽
function c21985407.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置效果处理信息，指定将从手牌特殊召唤怪兽
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND)
end
-- 定义效果处理函数，执行从手牌特殊召唤怪兽的操作
