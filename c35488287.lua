...
-- 执行特殊召唤流程，包括从手牌特殊召唤自身并可能从墓地特殊召唤炎星怪兽
function c35488287.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	-- 这个效果的发动后，直到回合结束时自己不是「炎星」怪兽不能特殊召唤。
	...
	-- 注册一个持续到回合结束的永续效果，禁止非炎星怪兽特殊召唤
	Duel.RegisterEffect(e1,tp)
end
-- 定义禁止特殊召唤的条件，即非炎星族怪兽不能特殊召唤
function c35488287.splimit(e,c)
	return not c:IsSetCard(0x79)
end
-- 定义代替破坏的过滤条件，即己方场上表侧表示的炎星族怪兽
...
-- 判断是否满足代替破坏的条件，即己方炎星怪兽被对方效果破坏且场上有炎舞卡
