...
function c60258960.initial_effect(c)
	...
	-- 在连锁发生时，标记这张卡在场上存在，用于后续判断魔法卡发动时该卡是否已在场上
