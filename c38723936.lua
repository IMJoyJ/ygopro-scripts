...
function c38723936.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if e:IsHasType(EFFECT_TYPE_ACTIVATE) then
		...
		-- 将效果注册到全局环境，使对方玩家在发动此卡时无法确认墓地中的卡。
