...
-- 判断是否满足发动条件，即场上同时存在风·水·炎·地属性的表侧表示怪兽
...
-- 判断是否满足发动条件，即满足以下任意一项：对方场上存在怪兽、对方场上存在魔法·陷阱卡、对方手牌数量大于等于2、自己可以抽2张卡
