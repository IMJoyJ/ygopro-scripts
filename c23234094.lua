...
-- 设置效果的发动条件，检查玩家场上是否有空位以及手牌中是否存在满足条件的怪兽
function c23234094.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置连锁处理信息，表明此效果将特殊召唤1只怪兽
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND)
end
-- 定义效果发动后的处理流程，包括检查场上空位、提示选择、选择目标怪兽并进行特殊召唤
function c23234094.spop(e,tp,eg,ep,ev,re,r,rp)
	-- 检查玩家场上是否还有空位，如果没有则不继续处理
