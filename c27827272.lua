...
-- 检查当前阶段是否为主要阶段1，是则发动效果
function c27827272.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- 判断是否为检查阶段，若为则返回当前阶段是否为主要阶段1
	if chk==0 then return Duel.GetCurrentPhase()==PHASE_MAIN1 end
	-- ①：以自己的怪兽区域1只「恶魔召唤」或者雷族怪兽为对象才能发动。
