...
function c46035545.initial_effect(c)
	-- 为这张卡添加灵摆怪兽属性，使其能够进行灵摆召唤并作为灵摆卡发动。
	...
	c:RegisterEffect(e2)
	-- 「DD 魔导贤者 尼古拉」的怪兽效果1回合只能使用1次。①：这张卡在灵摆区域被破坏的场合，以自己场上1只「DDD」怪兽为对象才能发动。那只怪兽回到持有者手卡，从自己的额外卡组选最多2只表侧表示的「DD」灵摆怪兽在自己的灵摆区域放置。那些卡的灵摆效果在这个回合不能发动。
...
-- 灵摆召唤限制的判定：若怪兽不是「DD」且召唤方式为灵摆召唤，则禁止该灵摆召唤。
