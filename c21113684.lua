...
function c21113684.initial_effect(c)
	...
	c:EnableReviveLimit()
	-- 添加融合召唤手续，使用满足条件的同调怪兽和魔法师族怪兽各1只为融合素材
...
function c21113684.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置连锁操作信息，表示将抽卡的对象为当前玩家
	Duel.SetTargetPlayer(tp)
	-- 设置连锁操作信息，表示将抽卡的数量为1张
