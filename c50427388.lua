...
function c50427388.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		-- 检查是否存在满足条件的对方怪兽（守备力不超过除外魔法卡数×300）
