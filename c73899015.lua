...
-- 起动效果的代价函数：判断当前卡本回合是否攻击过，并在此卡上附加“不能攻击宣言”的自肃效果
...
-- 起动效果的目标函数：检查并选择对方场上1只可以放置毒指示物的怪兽作为对象，并设置放置指示物的操作信息
...
-- 起动效果的处理函数：给目标怪兽放置1个毒指示物，并在此后触发相关自定义事件
