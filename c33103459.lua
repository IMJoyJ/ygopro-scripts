...
function c33103459.initial_effect(c)
	...
	if not c33103459.global_check then
		...
		-- 注册EVENT_SUMMON_SUCCESS事件的处理函数为aux.sumreg，用于处理“这张卡召唤的回合”的效果
...
-- 过滤函数，用于筛选满足条件的「娱乐伙伴」怪兽（可除外作为费用）
