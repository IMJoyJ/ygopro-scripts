...
local s,id,o=GetID()
-- 初始化卡片效果：注册①对方场上怪兽送墓效果（卡片发动）与②墓地除外双场表侧卡送墓效果（速攻效果）
function s.initial_effect(c)
	-- 注册关联卡名：「活死人的呼声」(97077563)
	aux.AddCodeList(c,97077563)
	-- 初始化卡片效果：注册①场上有不死族及「活死人的呼声」存在时以对方怪兽为对象送墓的效果
	...
	c:RegisterEffect(e1)
	-- 初始化卡片效果：注册②墓地除外自身，以双方场上表侧表示卡各1张为对象送墓的自由诱发效果
...
-- ①效果发动条件：自己场上同时存在表侧表示的不死族怪兽和「活死人的呼声」
