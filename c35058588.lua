...
-- 判断是否满足①效果的发动条件：自己场上存在「方界」怪兽且对方场上存在正面表示的怪兽
...
-- ①效果的处理函数：将选中的自己怪兽攻击力变为2倍，对方怪兽攻击力变为一半
