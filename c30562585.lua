...
-- 设置发动时的费用，使自己在发动回合不能进入战斗阶段
function c30562585.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- 判断当前阶段是否不是主要阶段2
	if chk==0 then return Duel.GetCurrentPhase()~=PHASE_MAIN2 end
	-- 自己手卡是0张的场合，选择自己墓地存在的1只名字带有「永火」的怪兽才能发动。
