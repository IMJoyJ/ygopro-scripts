...
function c43413875.initial_effect(c)
	c:EnableReviveLimit()
	-- 把「花札卫-芒上月-」以外的自己场上1只8星「花札卫」怪兽解放的场合可以特殊召唤。
