...
-- 定义了支付代价时的过滤条件，用于筛选满足条件的「堕天使」怪兽
...
function c50501121.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置操作信息，表明该效果属于破坏类别并指定目标数量
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,1,0,0)
end
-- 处理效果发动后的实际破坏行为，选择并破坏一张场上卡
