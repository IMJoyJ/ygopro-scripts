...
-- 当仪式怪兽进行仪式召唤时，此卡可作为仪式召唤所需的等级值参与计算。
function c47106439.rlevel(e,c)
	-- 获取此卡当前等级并确保不超过系统最大参数值。
