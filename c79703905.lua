...
function c79703905.initial_effect(c)
	...
	c:RegisterEffect(e2)
	-- 这张卡的召唤成功时，给这张卡放置场地存在的名字带有「云魔物」的怪兽数量的雾指示物。
...
-- 放置指示物处理：统计场上表侧表示的「云魔物」怪兽数量并为自身放置相应数量的雾指示物
function c79703905.addc(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsRelateToEffect(e) then
		-- 统计双方场上表侧表示的「云魔物」怪兽数量
