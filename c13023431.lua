...
function s.initial_effect(c)
	-- 添加融合召唤手续，使用满足matfilter1和matfilter2的怪兽各1只为融合素材
	...
	c:RegisterEffect(e3)
	-- 自己场上的其他战士族·地属性怪兽战斗破坏对方怪兽时可以特殊召唤
