...
function c37322745.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置效果处理时的操作信息，指定将要处理的卡为1张手牌。
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
-- 设置效果发动后的处理流程，包括提示选择、选择符合条件的怪兽并加入手牌。
