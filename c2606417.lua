...
-- 对方怪兽效果发动时触发效果的目标函数，判断目标是否可以被影响且满足召唤条件
...
-- 投掷硬币效果的处理函数，根据猜中结果决定是否特殊召唤并使目标怪兽无效化
