...
-- 过滤函数，用于筛选可以放置魔力指示物并能特殊召唤的怪兽
function c38325384.spfilter(c,e,tp)
	-- 筛选可以放置魔力指示物、能添加指示物且能特殊召唤的怪兽
