...
local s,id,o=GetID()
-- 创建效果，设置为发动时点，可以进行融合召唤和特殊召唤，并限制每回合只能发动一次
...
-- 效果的发动条件检查，确认卡组中存在至少一只「GMX」怪兽和一只恐龙族怪兽，并且至少有两张满足条件的卡
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		-- 检查卡组中是否存在至少一只「GMX」怪兽
