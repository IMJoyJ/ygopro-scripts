...
function c22227683.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置连锁操作信息，提示将要从卡组送去墓地的卡
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,nil,1,tp,LOCATION_DECK)
end
-- 处理效果发动时的主逻辑，包括选择并送去墓地的怪兽，以及提升攻击力和守备力
function c22227683.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	-- 注册一个持续到回合结束的战斗伤害无效效果
	Duel.RegisterEffect(e3,tp)
end
-- 定义筛选条件，用于选择可特殊召唤的「文具电子人」怪兽（等级不同）
