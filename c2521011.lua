...
function c2521011.initial_effect(c)
	...
	c:RegisterEffect(e1)
	-- 这张卡召唤·特殊召唤成功时，可以从卡组选1张名字带有「炎舞」的陷阱卡在自己场上盖放。
	...
	-- 设置效果值为当对方效果适用时，若该效果的发动玩家不是此卡的控制者，则该效果不适用
	e4:SetValue(aux.tgoval)
	c:RegisterEffect(e4)
end
-- 定义过滤函数，用于筛选场上表侧表示存在的名字带有「炎舞」的魔法·陷阱卡
