...
local s,id,o=GetID()
-- 注册卡名①②的效果，包括战斗阶段攻击次数增加和墓地效果的发动条件
...
-- 设置②效果第一个选项的目标选择函数，选择满足条件的墓地怪兽作为对象
function s.thtg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	-- 检查是否满足②效果第一个选项的发动条件，即墓地中是否存在满足条件的怪兽
...
function s.thtg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	-- 设置操作信息，表示将目标怪兽效果文本中记载的卡加入手牌
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,g,1,0,0)
end
-- ②效果第二个选项的处理函数，将目标怪兽效果文本中记载的卡加入手牌
