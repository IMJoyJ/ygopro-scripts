...
-- 过滤可作为融合素材的怪兽（怪兽卡、可作为融合素材、可送入墓地）
...
-- 过滤可融合召唤的「恐啡肽狂龙」融合怪兽（融合怪兽、所属卡组、可特殊召唤、符合融合素材条件）
...
-- 判断是否满足发动条件（基本分≤2000且为对方发动效果）
function c26631975.cdcon(e,tp,eg,ep,ev,re,r,rp)
	-- 自己基本分是2000以下，对方把魔法·陷阱·怪兽的效果发动时
