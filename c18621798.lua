...
-- 判断是否满足②效果的发动条件，即自身因破坏而进入墓地。
function c18621798.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsReason(REASON_DESTROY)
end
-- 定义过滤函数，用于筛选自己墓地中符合条件的炎属性兽族怪兽。
