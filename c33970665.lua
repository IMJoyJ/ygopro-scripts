...
-- 检索满足条件的卡片组，即名字带有「废铁」且可以被特殊召唤的怪兽。
...
-- 判断是否满足发动条件，即自己或对方场上存在空位，并且自己墓地存在3只名字带有「废铁」的怪兽。
