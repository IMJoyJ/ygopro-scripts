...
-- 检测场上是否存在「XYZ-神龙炮」或以它为融合素材的融合怪兽
function c21723081.cfilter(c)
	-- 判断怪兽是否为「XYZ-神龙炮」或以它为融合素材的融合怪兽
...
-- ●自己回合：以除外的1只自己的同盟怪兽为对象才能发动。那只怪兽回到卡组最下面，自己从卡组抽1张。●对方回合：把手卡任意数量丢弃，以那个数量的对方场上的卡为对象才能发动。那些卡破坏。
