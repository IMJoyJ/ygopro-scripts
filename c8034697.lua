...
function c8034697.initial_effect(c)
	...
	c:RegisterEffect(e2)
	-- 可以把这张卡放置的2个魔力指示物取除，场上存在的1只怪兽破坏。
