...
-- 判断此卡是否为仪式召唤成功且标记为属性种类大于1
function c45877457.matcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_RITUAL) and e:GetLabel()==1
end
-- 为该卡注册一个FlagEffect，用于标记仪式召唤使用的怪兽属性种类大于1
