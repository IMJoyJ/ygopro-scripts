...
-- 判断此卡是否为上级召唤成功 summoned by advance summon。
...
-- 设置发动效果的连锁操作信息，表示将要从卡组丢弃卡并回复基本分。
function c25451652.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置连锁操作信息，表示将要从卡组丢弃指定数量的卡。
	Duel.SetOperationInfo(0,CATEGORY_DECKDES,nil,0,tp,ct)
	-- 设置连锁操作信息，表示将要回复指定数量的基本分。
