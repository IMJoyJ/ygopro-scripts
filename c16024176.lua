...
function c16024176.initial_effect(c)
	c:EnableReviveLimit()
	-- 把「花札卫-松上鹤-」以外的自己场上1只1星「花札卫」怪兽解放的场合可以特殊召唤。
...
-- 处理特殊召唤成功后的效果，包括抽卡、确认、判断是否为花札卫怪兽并决定是否特殊召唤或送入墓地。
