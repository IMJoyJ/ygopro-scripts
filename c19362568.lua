...
function c19362568.initial_effect(c)
	-- ①：可以从以下效果选择1个发动。●以自己墓地1只「风魔女」怪兽为对象才能发动。那只怪兽守备表示特殊召唤。
	...
	c:RegisterEffect(e1)
	-- ①：可以从以下效果选择1个发动。●对方连锁自己的「风魔女」怪兽的效果的发动把魔法·陷阱·怪兽的效果发动时才能发动。那个对方的效果无效。
...
function c19362568.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	-- 判断是否满足发动条件，即场上是否有空怪兽区且自己墓地存在符合条件的怪兽
...
-- 判断是否满足无效效果的发动条件，即对方发动的效果是否可以被无效且该效果是否来自己方的「风魔女」怪兽
