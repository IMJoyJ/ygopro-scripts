...
-- ①效果的发动代价：从自己的手卡·墓地把1只「光道」怪兽除外
function c10071151.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- 检查自己手卡·墓地中是否存在满足条件的「光道」怪兽
...
-- ②效果的发动条件判断：这张卡以外的自己的「光道」怪兽的效果发动的场合
