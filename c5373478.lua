...
-- 效果作用：选择并确认一张手卡中的魔法卡给对方观看，然后洗切手牌
function c5373478.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- 效果作用：检查手卡中是否存在未公开的魔法卡
...
-- 效果作用：将该卡的卡名变更成「电子龙」（卡号70095154）直到结束阶段
