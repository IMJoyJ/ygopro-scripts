...
-- 过滤满足条件的同调怪兽（不死族、场上正面表示、非从额外卡组召唤）
...
-- 过滤满足条件的魔妖魔法/陷阱卡（魔妖卡组、魔法陷阱类型、可以盖放、非魔妖游行）
...
-- ●自己从卡组抽1张。●从卡组选「魔妖游行」以外的1张「魔妖」魔法·陷阱卡在自己场上盖放。●对方场上1只攻击力最低的怪兽送去墓地。●给与对方800伤害。
