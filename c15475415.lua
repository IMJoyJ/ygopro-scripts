...
function c15475415.initial_effect(c)
	-- 诱发选发效果，当自己对名字带有「外星」的怪兽的召唤成功时，这张卡可以从手卡特殊召唤
	...
	c:RegisterEffect(e1)
	-- 诱发必发效果，这个效果特殊召唤成功时，给对方场上表侧表示存在的怪兽放置2个A指示物
...
function c15475415.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	-- 执行特殊召唤操作，以自身效果为召唤条件，正面表示特殊召唤到自己场上
