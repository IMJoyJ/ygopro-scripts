...
function c69170557.initial_effect(c)
	...
	c:EnableReviveLimit()
	-- ①：这张卡特殊召唤成功的场合发动。有线指示物放置的怪兽全部破坏，自己从卡组抽1张。那之后，给予对方这个效果破坏送去墓地的怪兽之内原本攻击力最高的怪兽的那数值的伤害。
	...
	c:RegisterEffect(e1)
	-- ②：1回合1次，把这张卡1个超量素材去除才能发动。给对方场上的表侧表示怪兽全部各放置1个线指示物。
...
-- ②效果发动准备：检查对方场上是否存在可以放置线指示物的怪兽
function c69170557.cttg(e,tp,eg,ep,ev,re,r,rp,chk)
	-- 发动条件检查：对方场上是否存在可放置1个线指示物的怪兽
