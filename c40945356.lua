...
-- 过滤函数，用于判断场上是否存在满足条件的「忍者」或「忍法」怪兽。
...
-- 注册两个效果，使自己场上的「忍者」怪兽和「忍法」卡在本回合内不会被战斗和效果破坏。
