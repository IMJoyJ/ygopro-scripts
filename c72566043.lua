...
-- 过滤函数，检查墓地的卡是否为可盖放的陷阱卡
function c72566043.setfilter(c,tp)
	local chk=not c:IsControler(tp)
	-- 判定卡片是否为陷阱卡、是否可以盖放，且若盖放在己方场上则需要有可用的魔法与陷阱区域空格
