...
function c28593329.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		-- 作为对象的怪兽的攻击力直到回合结束时上升解放的天使族怪兽的原本攻击力数值。
		local e1=Effect.CreateEffect(c)
