...
function c40732515.spcon(e,c)
	...
	-- 返回是否满足特殊召唤条件（魔力指示物总数≥6 且 场上有空位）。
	return ct>=6 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
end
-- 执行特殊召唤时的处理操作，根据场上「魔法都市 恩底弥翁」的数量决定如何移除魔力指示物。
