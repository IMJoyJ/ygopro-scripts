...
-- 过滤满足条件的魔法卡，用于丢弃作为cost
function c40732515.cfilter(c)
	return c:IsType(TYPE_SPELL) and c:IsDiscardable()
end
-- 设置发动cost：丢弃一张手牌中的魔法卡
