...
-- 定义过滤函数，用于判断是否为「自奏圣乐」或「星遗物」怪兽。
function c29666221.cfilter(c)
	return c:IsSetCard(0xfe,0x11b)
end
-- 处理效果发动时的解放费用，检查并选择满足条件的怪兽进行解放。
