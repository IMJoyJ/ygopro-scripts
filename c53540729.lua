...
function c53540729.initial_effect(c)
	-- 效果原文内容：选择自己场上表侧表示存在的1只名字带有「发条」的怪兽才能发动。直到结束阶段时选择的1只怪兽的等级上升1星，攻击力上升600。这个效果只在这张卡在场上表侧表示存在能使用1次。
...
-- 效果作用：使对象怪兽在结束阶段时攻击力上升600，等级上升1
