...
-- 效果②的发动靶标：检查卡组中是否存在只在攻击宣言时才能发动的陷阱卡
...
-- 过滤不能被选择为攻击对象的怪兽：除「白银之城的魔神像」以外的表侧表示恶魔族怪兽
