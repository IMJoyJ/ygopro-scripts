...
function c2572890.condition2(e,tp,eg,ep,ev,re,r,rp)
	-- 判断效果发动时是否为怪兽类型的召唤，并且该连锁可以被无效。
	return re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev)
end
-- 设置第二效果的目标信息，包括无效发动和可能的破坏。
