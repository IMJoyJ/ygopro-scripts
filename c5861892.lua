...
-- 判断是否为反面效果触发条件，即抛硬币结果为反面且发动的是魔法或怪兽效果
...
function c5861892.negop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	-- 判断是否满足执行效果的条件（如不是表侧、攻击力不足或不在正确连锁中）
