...
-- 判断是否为正面效果触发条件：抛硬币结果为正面且参与战斗的怪兽被破坏送入墓地
...
-- 判断是否为反面效果触发条件：抛硬币结果为反面且该效果为目标卡时发动
