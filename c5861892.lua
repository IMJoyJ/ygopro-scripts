...
function c5861892.initial_effect(c)
	...
	c:RegisterEffect(e3)
	-- 受到对方怪兽的效果·魔法·陷阱卡发动时发动的效果，使攻击力下降1000并无效该发动且破坏
...
-- 判断是否为正面效果触发条件：抛硬币为正面且参与战斗的怪兽被破坏送入墓地
