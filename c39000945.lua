...
function c39000945.initial_effect(c)
	...
	c:RegisterEffect(e5)
	-- 当此卡离开场上的时候，将当前拥有的魔力指示物数量记录到效果5（从卡组加入手牌）中
...
-- 当有魔法卡发动时，若该卡在连锁中，则给此卡添加1个魔力指示物
