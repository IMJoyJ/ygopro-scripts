...
-- 筛选场上满足位置为主怪区、可作为融合素材、控制者为玩家或正面表示的卡片。
...
-- 执行特殊召唤操作，将符合条件的融合怪兽从额外卡组特殊召唤到场上。
