...
function c4918855.sptg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ct>0
		-- 检查是否存在满足条件的目标卡片（即对方墓地中可特殊召唤的怪兽）。
...
-- 定义了用于筛选特殊召唤成功怪兽的过滤条件，即该怪兽是从墓地召唤且为怪兽类型。
