...
-- ①效果的Target逻辑：检查怪兽区空位与对方墓地可特招怪兽，选择对方墓地最多2只怪兽为对象（受青眼精灵龙限制）。
