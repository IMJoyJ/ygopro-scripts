...
-- 检查是否可以解放场上1只名字带有「宝石骑士」的怪兽作为发动代价
...
function c41777.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	-- 设置连锁操作信息，表明将要特殊召唤1张卡
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g,1,0,0)
	e:SetLabel(0)
end
-- 执行效果的处理逻辑，将目标卡从墓地特殊召唤到场上
