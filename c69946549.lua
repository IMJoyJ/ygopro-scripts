...
-- 等级变更效果持续条件：目标怪兽身上仍有捕食指示物
function c69946549.lvcon(e)
	return e:GetHandler():GetCounter(0x1041)>0
end
-- ②效果无效条件：由对方发动的怪兽效果且发动效果的怪兽带放有捕食指示物
