...
function c65187687.initial_effect(c)
	...
	c:RegisterEffect(e1)
	-- 效果②：己方怪兽区域存在且从墓地特殊召唤怪兽时发动，使对方场上1只表侧表示怪兽效果无效
