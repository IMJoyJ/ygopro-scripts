...
-- 检索满足条件的「彼岸」怪兽（在墓地、本回合被送去墓地、不是因返回墓地的原因、可以特殊召唤）
...
-- 判断是否满足发动条件（场上有空位、墓地有符合条件的怪兽）
function c20036055.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	-- 作为目标选择函数，判断所选卡片是否满足条件（在墓地、是自己控制的、是「彼岸」怪兽、是本回合被送去墓地的、不是因返回墓地的原因）
