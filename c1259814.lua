...
function c1259814.initial_effect(c)
	...
	c:RegisterEffect(e0)
	-- 效果原文内容：①：1回合1次，以场上1只表侧表示怪兽为对象才能发动。
...
-- 规则层面操作：判断目标怪兽是否满足效果发动条件（表侧表示且种族不是机械族或属性不足6种）
