...
-- 连锁处理时若有魔法卡发动（这张卡自身除外），给这张卡放置1个魔力指示物
...
-- 判断是否为让卡的效果发动而作为代价由这张卡的控制者取除自己场上的魔力指示物，且这张卡放置的魔力指示物数量足以代替取除
