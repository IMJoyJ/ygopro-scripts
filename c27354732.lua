...
function c27354732.condition(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	-- 对方怪兽的效果发动且该效果为怪兽类型，且自身未在战斗中被破坏
