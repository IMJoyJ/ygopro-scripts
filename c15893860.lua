...
-- 检查是否满足发动条件，即己方场上有水属性怪兽且对方场上存在可放置冰指示物的怪兽
...
function c15893860.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	-- 判断是否满足破坏对方场上卡的条件，即冰指示物数量大于等于3且玩家选择发动该效果
