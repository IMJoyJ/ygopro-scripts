...
function c22933016.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:IsHasType(EFFECT_TYPE_ACTIVATE) then
		...
		-- 注册限制效果，禁止玩家在本回合特殊召唤非电子界族怪兽
		Duel.RegisterEffect(e1,tp)
	end
end
-- 限制效果的目标函数，禁止电子界族怪兽特殊召唤
...
-- 判断是否满足效果发动条件（墓地或除外区是否存在符合条件的魔法陷阱卡）
