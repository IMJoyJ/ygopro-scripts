...
-- 判断是否满足发动条件，即场上是否有空位且卡组有符合条件的怪兽
...
function c33327029.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置连锁操作信息，表示将灵摆怪兽加入手牌
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_EXTRA)
end
-- 定义效果发动时的操作，包括选择并加入手牌
