...
-- 判断目标怪兽是否满足「光道」怪兽且等级大于0且能加入手牌，并且卡组顶部的卡数量足够除外。
...
function c24037702.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	-- 设置效果处理时将目标怪兽加入手牌的操作信息。
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,g,1,0,0)
	-- 设置效果处理时将卡组顶部指定数量的卡除外的操作信息。
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,rg,rg:GetCount(),0,0)
end
-- 那只怪兽加入手卡。那之后，把加入手卡的那只怪兽的原本等级数量的卡从自己卡组上面除外。
