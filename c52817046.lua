...
function c52817046.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	-- 效果作用：将目标玩家手牌全部送入卡组并洗切
	Duel.SendtoDeck(g,nil,SEQ_DECKSHUFFLE,REASON_EFFECT)
	-- 效果作用：洗切目标玩家的卡组
	Duel.ShuffleDeck(p)
	-- 效果作用：中断当前连锁处理
	Duel.BreakEffect()
	-- 效果作用：让目标玩家抽取与送入卡组数量相同的卡
