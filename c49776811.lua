...
function c49776811.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup() then
		...
		-- 当指示物数量为1时，询问是否从卡组选1只怪兽放置在卡组最上方。
