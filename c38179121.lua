...
-- 发动时从手卡·墓地选择1只恐龙族怪兽和1只非恐龙族怪兽除外作为代价
function c38179121.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- 获取手卡·墓地中的所有怪兽作为可选除外对象
...
-- 设置发动时的处理信息，确认场上存在召唤怪兽的空间并卡组·手卡中存在满足条件的怪兽
...
-- 发动效果时从卡组·手卡中选择1只7星以上的恐龙族怪兽特殊召唤
