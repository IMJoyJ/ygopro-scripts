...
-- 效果①目标选择阶段：选择对方墓地1张可以返回卡组的卡作为对象
...
-- 筛选条件：名字带有「王家长眠之谷」的卡（系列代码0x91）且可以加入手卡
function c22134079.filter(c)
	return c:IsSetCard(0x91) and c:IsAbleToHand()
end
-- 效果②目标选择阶段：选择自己墓地1张名字带有「王家长眠之谷」的卡作为对象
