...
-- 检索满足条件的墓地或场上的战士、同调士、星尘系列同调怪兽，用于判断是否满足②效果的发动条件
...
-- 判断是否有满足条件的同调怪兽存在于己方场上或墓地，用于②效果的发动条件
function c57458399.lvcon(e,tp,eg,ep,ev,re,r,rp)
	-- 检查己方场上或墓地是否存在符合条件的同调怪兽
