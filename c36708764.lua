...
-- 1·自己基本分变成一半。2·那次攻击变成对自己的直接攻击。3·选自己场上1只怪兽，攻击对象转移为那只怪兽进行伤害计算。4·选攻击怪兽以外的对方场上1只怪兽，攻击对象转移为那只怪兽进行伤害计算。5·那次攻击无效，给与对方那只怪兽的攻击力数值的伤害。6·那只对方怪兽破坏。
