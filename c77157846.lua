...
local s,id,o=GetID()
-- 初始化卡片效果：注册灵摆属性、P效果①灵摆召唤限制、P效果②怪兽特召回手效果、怪兽效果①手牌特召效果、怪兽效果②炸灵摆卡表侧送额外效果
