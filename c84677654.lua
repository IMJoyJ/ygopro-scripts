...
function c84677654.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 设置投掷硬币的操作信息，双方玩家共同投掷共2次硬币
	Duel.SetOperationInfo(0,CATEGORY_COIN,nil,0,PLAYER_ALL,2)
end
-- 效果的处理：获取宣言的等级并投掷硬币，根据正反面结果改变怪兽等级或扣除基本分
