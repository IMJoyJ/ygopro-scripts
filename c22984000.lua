...
function s.initial_effect(c)
	...
	c:EnableReviveLimit()
	-- 注册第一个效果：超量召唤成功时可从卡组选择1只怪兽作为超量素材
	...
	c:RegisterEffect(e1)
	-- 注册第二个效果：只要持有超量素材，对方不能发动与己方墓地相同属性的怪兽效果
	...
	c:RegisterEffect(e2)
	-- 注册第三个效果：结束阶段可以选择取除一个超量素材或受到3000伤害
...
function s.rmtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- 向对方提示选择发动了“取除素材或伤害”效果
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
end
-- 执行第三个效果的操作，选择取除超量素材或受到3000伤害
