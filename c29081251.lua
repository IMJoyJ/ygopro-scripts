...
function s.ntcon(e,c,minc)
	...
	-- 如果minc为0（非先行卡），且这张卡的等级大于等于5，并且玩家场上存在空位则返回true。
