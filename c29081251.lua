...
local s,id,o=GetID()
-- 初始化效果函数，创建三个效果：①不用解放召唤；②召唤·特殊召唤时从卡组送1只6星以上不死族怪兽到墓地并可从墓地将1只6星以上不死族怪兽加入手牌；③在怪兽区域存在且有怪兽从墓地特殊召唤时进行1只不死族超量怪兽的超量召唤
...
-- 效果③的发动条件判断：是否有从墓地特殊召唤的怪兽且不包含自身
