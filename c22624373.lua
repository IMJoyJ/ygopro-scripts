...
function c22624373.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsPosition(POS_FACEUP_ATTACK) then
		...
		-- 这个效果的发动后，直到下次的自己回合的结束时这张卡不能把表示形式变更。
		local e1=Effect.CreateEffect(c)
