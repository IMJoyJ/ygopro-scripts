...
function c73262676.initial_effect(c)
	-- 以自己场上1只表侧表示的「外星」怪兽为对象才能发动。选择的怪兽破坏，在对方场上的表侧表示怪兽上放置破坏怪兽等级数量的A指示物。
